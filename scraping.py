...
# Scrape Mars News
# return news title and article teaser 
...
# JPL Space Images Featured Image, return as img url string
...
def mars_facts():
    ...
    dataTableHTML = df.to_html(classes = "table table-striped table-responsive table-hover table-condensed dataframe")
